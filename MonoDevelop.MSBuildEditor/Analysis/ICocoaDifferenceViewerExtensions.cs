	...
	internal static class ICocoaDifferenceViewerExtensions
	{
		private class SizeToFitHelper
		{
			...
			public async Task SizeToFitAsync ()
			{
				...
				//HACK: work around a bug in the Cocoa difference viewer
		...
		public static Task SizeToFitAsync (this ICocoaDifferenceViewer diffViewer, double minWidth = 400.0)
		{
