...
namespace MonoDevelop.MSBuildEditor.Schema
{
	...
	static class Builtins
	{
		...
		static Builtins ()
		{
			...
			AddMetadata ("RootDir", "The root directory of the item", MSBuildValueKind.Folder);
			...
			AddMetadata ("RelativeDir", "The path specified in the Include attribute", MSBuildValueKind.Folder);
			AddMetadata ("Directory", "The directory of the item, excluding the root directory", MSBuildValueKind.Folder);
			AddMetadata ("RecursiveDir", "If the item contained a ** wildstar, the value to which it was expanded", MSBuildValueKind.Folder);
			...
			AddProperty ("MSBuildThisFileDirectory", "Directory where the current MSBuild file is located. Includes final backslash.", MSBuildValueKind.Folder);
			AddProperty ("MSBuildThisFileDirectoryNoRoot", "Directory where the current MSBuild file is located, excluding drive root. Includes final backslash.", MSBuildValueKind.Folder);
			...
			AddProperty ("MSBuildUserExtensionsPath", "Directory from which user extensions are imported", MSBuildValueKind.Folder);
			AddProperty ("LocalAppData", "The local application data directory", MSBuildValueKind.Folder);
			...
			AddProperty ("MSBuildFrameworkToolsRoot", "The root directory of the .NET framework tools", MSBuildValueKind.Folder);
